...
| Neurotechnology & Neural Engineering | [`NNE-0001`](09-Auxiliary-Studies/06-Neurotechnology-Neural-Engineering/lessons/NNE-0001-what-neurotechnology-and-neural-engineering-are-actually-studying.md) | [`NNE-0015 — Extracellular spikes, multi-unit activity, and local field potentials`](09-Auxiliary-Studies/06-Neurotechnology-Neural-Engineering/lessons/NNE-0015-extracellular-spikes-multi-unit-activity-and-local-field-potentials.md) |
