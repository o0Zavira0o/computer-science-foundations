...
|---|---|---|
| Linear Algebra | [`LA-0001`](01-Linear-Algebra/lessons/LA-0001-what-linear-algebra-is-actually-studying.md) | [`LA-0011 — Elimination: changing equations without changing solutions`](01-Linear-Algebra/lessons/LA-0011-elimination-changing-equations-without-changing-solutions.md) |
...
| Neurotechnology & Neural Engineering | [`NNE-0001`](09-Auxiliary-Studies/06-Neurotechnology-Neural-Engineering/lessons/NNE-0001-what-neurotechnology-and-neural-engineering-are-actually-studying.md) | [`NNE-0009 — The neural measurement chain: source, tissue, sensor, electronics, data, and inference`](09-Auxiliary-Studies/06-Neurotechnology-Neural-Engineering/lessons/NNE-0009-the-neural-measurement-chain-source-tissue-sensor-electronics-data-and-inference.md) |
