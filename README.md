...
|---|---|---|
| Linear Algebra | [`LA-0001`](01-Linear-Algebra/lessons/LA-0001-what-linear-algebra-is-actually-studying.md) | [`LA-0015 — Invertibility as reversible linear action`](01-Linear-Algebra/lessons/LA-0015-invertibility-as-reversible-linear-action.md) |
...
| Neurotechnology & Neural Engineering | [`NNE-0001`](09-Auxiliary-Studies/06-Neurotechnology-Neural-Engineering/lessons/NNE-0001-what-neurotechnology-and-neural-engineering-are-actually-studying.md) | [`NNE-0013 — The electrode-tissue interface: charge transfer, impedance, and what an electrode actually senses`](09-Auxiliary-Studies/06-Neurotechnology-Neural-Engineering/lessons/NNE-0013-the-electrode-tissue-interface-charge-transfer-impedance-and-what-an-electrode-actually-senses.md) |
