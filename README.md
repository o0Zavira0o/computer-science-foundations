...
|---|---|---|
| Linear Algebra | [`LA-0001`](01-Linear-Algebra/lessons/LA-0001-what-linear-algebra-is-actually-studying.md) | [`LA-0014 — Composition and matrix multiplication`](01-Linear-Algebra/lessons/LA-0014-composition-and-matrix-multiplication.md) |
...
| Neurotechnology & Neural Engineering | [`NNE-0001`](09-Auxiliary-Studies/06-Neurotechnology-Neural-Engineering/lessons/NNE-0001-what-neurotechnology-and-neural-engineering-are-actually-studying.md) | [`NNE-0012 — Resolution, selectivity, bandwidth, invasiveness, stability, and safety as coupled tradeoffs`](09-Auxiliary-Studies/06-Neurotechnology-Neural-Engineering/lessons/NNE-0012-resolution-selectivity-bandwidth-invasiveness-stability-and-safety-as-coupled-tradeoffs.md) |
