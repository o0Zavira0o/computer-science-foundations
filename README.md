...
|---|---|---|
| Linear Algebra | [`LA-0001`](01-Linear-Algebra/lessons/LA-0001-what-linear-algebra-is-actually-studying.md) | [`LA-0009 — Matrices as organized coefficients and operators`](01-Linear-Algebra/lessons/LA-0009-matrices-as-organized-coefficients-and-operators.md) |
...
| Neurotechnology & Neural Engineering | [`NNE-0001`](09-Auxiliary-Studies/06-Neurotechnology-Neural-Engineering/lessons/NNE-0001-what-neurotechnology-and-neural-engineering-are-actually-studying.md) | [`NNE-0007 — From single neurons to populations, circuits, systems, and behavior`](09-Auxiliary-Studies/06-Neurotechnology-Neural-Engineering/lessons/NNE-0007-from-single-neurons-to-populations-circuits-systems-and-behavior.md) |
