...
|---|---|---|
| Linear Algebra | [`LA-0001`](01-Linear-Algebra/lessons/LA-0001-what-linear-algebra-is-actually-studying.md) | [`LA-0016 — L0 synthesis: solve, transform, and explain one problem three ways`](01-Linear-Algebra/lessons/LA-0016-l0-synthesis-solve-transform-and-explain-one-problem-three-ways.md) |
...
| Neurotechnology & Neural Engineering | [`NNE-0001`](09-Auxiliary-Studies/06-Neurotechnology-Neural-Engineering/lessons/NNE-0001-what-neurotechnology-and-neural-engineering-are-actually-studying.md) | [`NNE-0014 — Intracellular recording and patch clamp as a window into membrane voltage and currents`](09-Auxiliary-Studies/06-Neurotechnology-Neural-Engineering/lessons/NNE-0014-intracellular-recording-and-patch-clamp-as-a-window-into-membrane-voltage-and-currents.md) |
