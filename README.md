...
|---|---|---|
| Linear Algebra | [`LA-0001`](01-Linear-Algebra/lessons/LA-0001-what-linear-algebra-is-actually-studying.md) | [`LA-0010 — Matrix-vector multiplication as a column combination`](01-Linear-Algebra/lessons/LA-0010-matrix-vector-multiplication-as-a-column-combination.md) |
...
| Neurotechnology & Neural Engineering | [`NNE-0001`](09-Auxiliary-Studies/06-Neurotechnology-Neural-Engineering/lessons/NNE-0001-what-neurotechnology-and-neural-engineering-are-actually-studying.md) | [`NNE-0008 — What counts as a neural signal: spikes, field potentials, rhythms, chemistry, and hemodynamics`](09-Auxiliary-Studies/06-Neurotechnology-Neural-Engineering/lessons/NNE-0008-what-counts-as-a-neural-signal-spikes-field-potentials-rhythms-chemistry-and-hemodynamics.md) |
